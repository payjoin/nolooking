// Originally copied from: https://github.com/Kixunil/payjoin/blob/master/payjoin-client/src/main.rs
...
fn main() {
    ...
    let client = bitcoincore_rpc::Client::new(
        ...
        bitcoincore_rpc::Auth::UserPass(String::from("polaruser"), String::from("polarpass")),
    )
    .unwrap();
