...
RUN cargo --config "net.git-fetch-with-cli=true" install --all-features --target x86_64-unknown-linux-musl --path .
...
RUN cargo --config "net.git-fetch-with-cli=true" install --all-features --target aarch64-unknown-linux-musl --path .
